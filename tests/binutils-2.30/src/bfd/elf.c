...
#ifdef MANUAL
      {
        dfsan_label lbl = dfsan_get_label(hdr->sh_size);
        if (lbl) {
          struct dfsan_label_info * lbl_i = dfsan_get_label_info(lbl);
          printf("hdr->sh_size: %u %f %f %u", lbl, lbl_i->neg_dydx,
              lbl_i->pos_dydx, mark_ind);
        }
      }
#endif
...
/*#ifdef MANUAL*/
  /*dfsan_label l = dfsan_get_label(hdr->sh_size);*/
  /*const struct dfsan_label_info* li;*/
    /*li = dfsan_get_label_info(l);*/
    /*printf("%s, %zu, %zu, %u, %zu, %f, %f\n", name, hdr_size_ind, mark_ind, l, hdr->sh_size, li->neg_dydx, li->pos_dydx);*/
    /*hdr_size_ind++;*/
/*#endif*/
